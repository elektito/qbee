...
def_instr('eq', 20)
def_instr('eqv', 21)
def_instr('errget', 138)
def_instr('errhand', 139, [Label])
def_instr('errline', 141)
def_instr('errraise', 142)
def_instr('errres', 143)
def_instr('errresn', 144)
def_instr('exp', 22)
...
def_instr('idiv', 25)
def_instr('ijmp', 109)
def_instr('initarrg', 126, [UInt16, UInt8, Int32])
def_instr('initarrl', 127, [UInt16, UInt8, Int32])
def_instr('int', 111)
def_instr('imp', 26)
def_instr('io', 27, [UInt8, UInt8])
def_instr('jmp', 28, [Label])
def_instr('jz', 29, [Label])
def_instr('lbound', 133)
def_instr('lcase', 115)
def_instr('le', 30)
def_instr('lt', 31)
def_instr('ltrim', 131)
...
def_instr('strfind', 135)
def_instr('strleft', 118)
def_instr('strlen', 110)
def_instr('strmid', 120)
def_instr('strrep', 128)
def_instr('strright', 119)
def_instr('swap', 107)
def_instr('swapprev', 108)
def_instr('ubound', 134)
def_instr('ucase', 114)
def_instr('xor', 99)
